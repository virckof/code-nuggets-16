package edu.ca.ualberta.code.nuggets.views;
 ...
 */
public class NuggetView extends ViewPart {
	...
	public void showSelection(IWorkbenchPart sourcepart, ISelection selection) {
		...
		/* In case we ever want to play with other selected elements
